...
export const EGEO_DEMO_MENU_SDS_VERIFIED: SdsDemoMenu[] = [
   ...
   { id: 'sds-link', name: 'Link', path: 'link-demo', moduleLazyLoad: 'SdsLinkDemoModule' },
...
const routes: Routes = [
   ...
   { path: 'link-demo', loadChildren: () => import( './sds-link-demo/sds-link-demo.module').then(m => m.SdsLinkDemoModule ) },
