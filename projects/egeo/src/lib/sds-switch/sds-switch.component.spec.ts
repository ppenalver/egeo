...
import {SdsSwitchComponent} from './sds-switch.component';

let fixture: ComponentFixture<SdsSwitchComponent>;
let component: SdsSwitchComponent;
let model: boolean = true;
let formGroup: FormGroup;

describe('SdsSwitchComponent', () => {

   beforeEach(() => {
      TestBed.configureTestingModule({
         imports: [FormsModule, ReactiveFormsModule, StLabelModule],
         declarations: [SdsSwitchComponent]
      })
   ...
   beforeEach(() => {
      ...
      fixture = TestBed.createComponent(SdsSwitchComponent);
      component = fixture.componentInstance;
      component.value = false;
      component.qaTag = 'qa tag';
   });

   it('should be added the class sds-switch to the root', () => {
      expect(fixture.nativeElement.classList).toContain('sds-switch');
   });
   ...
   describe('Should update its class when disabled attribute changes', () => {
      ...
      it('if it is disabled, class "sds-switch--disabled" has to be added to toggle', () => {
         component.setDisabledState(true);
         fixture.detectChanges();

         expect(fixture.nativeElement.querySelector('.sds-switch').classList).toContain('sds-switch--disabled');
      });

      it('if it is enabled, class "sds-switch--disabled" hos to be removed from toggle', () => {
         component.setDisabledState(false);
         fixture.detectChanges();

         expect(fixture.nativeElement.querySelector('.sds-switch').classList).not.toContain('sds-switch--disabled');
      });
   });
   ...
   describe('when user clicks on toggle', () => {
      ...
      it('if switch is not disabled, model has to change', () => {
         ...
         let switchBox: HTMLDivElement = fixture.nativeElement.querySelector('.sds-switch');
         ...
         expect(switchBox.classList).toContain('sds-switch--checked');
         ...
         expect(switchBox.classList).not.toContain('sds-switch--checked');
      });
   ...
   it('If model is changed from outside, switch is updated', () => {
      ...
      switchBox = fixture.nativeElement.querySelector('.sds-switch');
