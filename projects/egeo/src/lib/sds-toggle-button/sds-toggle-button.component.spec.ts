...
import { SdsToggleButtonComponent } from './sds-toggle-button.component';
import { StToggleButton, StParsedToggleButton } from './sds-toggle-button.interface';


let comp: SdsToggleButtonComponent;
let fixture: ComponentFixture<SdsToggleButtonComponent>;
let de: DebugElement;
...
const tabActiveCSSClass = 'sds-toggle-button__button--active';
const realisticClick = new Event('click', { bubbles: true });

describe('SdsToggleButtonComponent', () => {

   beforeEach(() => {
      TestBed.configureTestingModule({
         imports: [RouterTestingModule],
         declarations: [SdsToggleButtonComponent]
      })
         .compileComponents();  // compile template and css
   });

   beforeEach(() => {
      fixture = TestBed.createComponent(SdsToggleButtonComponent);
   ...
   it('should init correctly', () => {
      ...
      let options: DebugElement[] = fixture.debugElement.queryAll(By.css('.sds-toggle-button__button'));
