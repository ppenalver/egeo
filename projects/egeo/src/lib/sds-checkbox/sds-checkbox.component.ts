...
export const CHECKBOX_CONTROL_ACCESSOR: any = {
   ...
   useExisting: forwardRef(() => SdsCheckboxComponent),
   multi: true
};
 ...
 *
 * ```
 * <sds-checkbox name="option" value="1">
 *    Option 1
 * </sds-checkbox>
 * ```
 *
...
@Component({
   ...
   templateUrl: './sds-checkbox.component.html',
   styleUrls: ['./sds-checkbox.component.scss'],
   providers: [CHECKBOX_CONTROL_ACCESSOR],
   changeDetection: ChangeDetectionStrategy.OnPush
})

export class SdsCheckboxComponent implements ControlValueAccessor {
