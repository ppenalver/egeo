...
import { SdsCheckboxComponent } from './sds-checkbox.component';

describe('SdsCheckboxComponent', () => {

   let component: SdsCheckboxComponent;
   let fixture: ComponentFixture<SdsCheckboxComponent>;
   let compiled: any;
   let de: DebugElement;

   beforeEach(() => {
      TestBed.configureTestingModule({
         declarations: [SdsCheckboxComponent]
      })
         .compileComponents();  // compile template and css
   });

   beforeEach(() => {
      fixture = TestBed.createComponent(SdsCheckboxComponent);
   ...
   describe('When clicked about the component', () => {
      it('Should mark as checked the input', () => {
         compiled.querySelector('.sds-checkbox').click();
         fixture.detectChanges();
         expect(compiled.querySelector('input').checked).toBeTruthy();
      });
   });
