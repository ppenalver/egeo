...
import { SdsRadioComponent } from './sds-radio.component';

describe('SdsRadioComponent', () => {

   let component: SdsRadioComponent;
   let fixture: ComponentFixture<SdsRadioComponent>;
   let compiled: any;

   beforeEach(() => {
      TestBed.configureTestingModule({
         declarations: [SdsRadioComponent],
         providers: [
            SelectOneDispatcher
         ]
      })
   ...
   beforeEach(() => {
      fixture = TestBed.createComponent(SdsRadioComponent);
