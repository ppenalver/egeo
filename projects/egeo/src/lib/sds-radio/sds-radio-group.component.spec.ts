...
import { SdsRadioComponent, SdsRadioGroupComponent } from './sds-radio.component';

describe('SdsRadioGroup', () => {

   @Component({
      template: `
            <sds-radio-group [(ngModel)]="modelValue" (change)="lastEvent = $event">
                  <sds-radio *ngFor="let item of items" [value]="item.value">
                  {{item.label}}
                  </sds-radio>
            </sds-radio-group>
      `
   ...
   let groupInstance: SdsRadioGroupComponent;
   let radioInstances: SdsRadioComponent[];
   ...
   beforeEach(() => {
      TestBed.configureTestingModule({
         ...
         declarations: [SdsRadioComponent, SdsRadioGroupComponent, RadioGroupWithModel],
         providers: [
            SelectOneDispatcher
         ]
      })
   ...
   beforeEach(() => {
      ...
      groupDebugElement = fixture.debugElement.query(By.directive(SdsRadioGroupComponent));
      groupNativeElement = groupDebugElement.nativeElement;
      groupInstance = groupDebugElement.injector.get(SdsRadioGroupComponent);

      radioDebugElements = fixture.debugElement.queryAll(By.directive(SdsRadioComponent));
...
describe('SdsRadioGroup with FormControl', () => {

    // tslint:disable-next-line:max-classes-per-file
   @Component({
      template: `
         <sds-radio-group [formControl]="formControl">
            <sds-radio value="1">One</sds-radio>
         </sds-radio-group>
      `
   })
   class RadioGroup {
   ...
   beforeEach(() => {
      TestBed.configureTestingModule({
         ...
         declarations: [SdsRadioComponent, SdsRadioGroupComponent, RadioGroup],
         providers: [
            SelectOneDispatcher
         ]
      })
